  ...
  render() {
    return (
      <div id='content-view'>
        ...
        <div className="content" > {this.props.pageState.currentPage === 4 ? <SearchCompany apiData={this.props.apiState.apiData} getApiData={this.getApiData.bind(this)}/> : null }</div>
